...
### 2. To make your life easier, [add your public key](./ssh.md).
 So you have *SSH* access. To ensure you have it, I want to see **an image on this page** of you using `SSH -T git@github.com`, this will confirm you have SSH access. It needs to look like this: ![](./static/ssh.png)
...
### 6. Edit this page in [Markdown](./markdown.md), so it looks identical to this image; ![](./static/README.png). 
...
6. Remove this instructional content.
